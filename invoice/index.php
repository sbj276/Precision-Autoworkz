					  ...
					  <table  align="center">
                        <thead>  
						   ...
						   <col width="200">
                            ...
                            <th>Part Labour(excluding taxes)</th>  
                            <th>Amount(Including taxes)</th>  
						...
						<?php
							...
							?>
                            <tr>  
                                <td class="no"><?php global $i; echo $i+1;?></td>  
                                <td align="left"><textarea rows="4" cols="42" name="productname[]"></textarea></td>  
                                <td><input type="number" style="text-align:center; border: none" class="form-control quantity" name="quantity[]"></td>  
                                <td><input type="number" style="text-align:center;border: none" class="form-control price" name="price[]"></td>  
                                <td><input type="number" style="text-align:center;border: none" class="form-control discount" name="discount[]" value="0"></td>  
                                <td><input type="number"  style="text-align:center;border: none" class="form-control amount" name="amount[]" ></td>  
...
var amt =(qty * price)+((13.5/100) * (qty * price))+dis+((15/100) * dis);  
...
<br>
<hr>
<center> Invoice is inclusive of VAT @13.5% of total job/parts amount
        <br> & Service Tax@14% <br>Swachh Bharat Tax@0.50%
		<br>Krishi Kalyan Cess@ 0.50% on total Labour </center>
